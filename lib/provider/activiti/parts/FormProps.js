...
module.exports = function(group, element, bpmnFactory, translate) {
  ...
  group.entries.push(entryFactory.selectBox(translate, {
    ...
    selectOptions: [
      ...
      { value: 'formRef', name: translate('Activiti Forms') }
    ],
    ...
    get: function(element, node) {
      ...
      if (!isUndefined(businessObject.get('activiti:formKey'))) {
        values.formType = 'formKey';
      } else if (!isUndefined(businessObject.get('activiti:formRef'))) {
    ...
    set: function(element, values, node) {
      ...
      if (value === 'formKey') {
        ...
        properties = {
          'activiti:formRef': undefined,
          'activiti:formRefBinding': undefined,
          'activiti:formRefVersion': undefined,
          'activiti:formKey': undefined
        };
      }
  ...
  group.entries.push(entryFactory.textField(translate, {
    ...
    get: function(element, node) {
      ...
      return {
        formRef: businessObject.get('activiti:formRef')
      };
    },
    set: function(element, values, node) {
      var businessObject = getBusinessObject(element),
      ...
      return cmdHelper.updateBusinessObject(element, businessObject, { 'activiti:formRef': formRef });
    },
    hidden: function(element, node) {
      var formType = getFormType(element);
  ...
  group.entries.push(entryFactory.textField(translate, {
    ...
    get: function(element, node) {
      ...
      return {
        formRefVersion: businessObject.get('activiti:formRefVersion')
      };
    },
    set: function(element, values, node) {
      var businessObject = getBusinessObject(element),
      ...
      return cmdHelper.updateBusinessObject(element, businessObject, { 'activiti:formRefVersion': formRefVersion });
    },
    hidden: function(element, node) {
...
function getFormRefBinding(element) {
  ...
  return businessObject.get('activiti:formRefBinding');
}
